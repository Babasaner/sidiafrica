      ...
      <section className="pt-32 pb-16 bg-sidi-blue text-white relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl max-w-3xl mb-6">
            Consultez le programme complet du Salon Guinée Invest du 30 mai 2025 dans ce calendrier interactif. Cliquez
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="section-title mb-8">Programme du 30 mai 2025</h2>
